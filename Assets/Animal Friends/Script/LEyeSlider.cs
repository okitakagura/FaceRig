...
public class LEyeSlider : MonoBehaviour
{
    ...
    public static float left = -0.19f;
    ...
    public void handleValuChange()
    {
        ...
        switch (axis)
        {
            case Axis.X:
                ...
                GameObject LMouth = GameObject.Find("LeftEyeSlider");
                Slider LSlider = LMouth.GetComponent<Slider>();
                GameObject RMouth = GameObject.Find("RightEyeSlider");
