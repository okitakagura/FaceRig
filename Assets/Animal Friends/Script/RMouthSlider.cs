...
//    Z
//}
public class RMouthSlider : MonoBehaviour
{
    public GameObject target;
    public Slider slider;
    public Axis axis = Axis.Z;//按照此轴进行移动
    public float left_bottom_back = 0.14f;//左边界
    public float right_up_forward = 0.19f;//右边界
    private float D_value;//左右边界的差值
    public static float right = -0.076f;
