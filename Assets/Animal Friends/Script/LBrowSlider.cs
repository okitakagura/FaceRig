...
public class LBrowSlider : MonoBehaviour
{
    ...
    public static float left = -0.28f;
    ...
    public void handleValuChange()
    {
        ...
        switch (axis)
        {
            case Axis.X:
                ...
                GameObject LMouth = GameObject.Find("LeftEyebrowSlider");
                Slider LSlider = LMouth.GetComponent<Slider>();
                GameObject RMouth = GameObject.Find("RightEyebrowSlider");
