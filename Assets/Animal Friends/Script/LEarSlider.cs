...
public class LEarSlider : MonoBehaviour {
	...
	public void handleValuChange()
	{
		...
		case Axis.X:
            ...
            GameObject LEar = GameObject.Find("LeftEarSlider");
                Slider LSlider = LEar.GetComponent<Slider>(); 
                GameObject REar = GameObject.Find("RightEarSlider");
                Slider RSlider = REar.GetComponent<Slider>();
