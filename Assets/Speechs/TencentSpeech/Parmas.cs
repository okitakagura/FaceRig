...
namespace TencentSpeech
{
    ...
    public class Params
    {
        ...
        //public int speaker = (int)Speaker.欢馨女声;//   是 int 正整数 	1 	语音发音人编码，定义见下文描述
        public int speaker = 5;//   是 int 正整数   1   语音发音人编码，定义见下文描述
        ...
        public string text ="Hello World";//    是 string UTF-8编码，非空且长度上限150字节 腾讯，你好！ 	待合成文本
